...
const userSchema = new Schema({
  ...
  wishlist: {type: [Schema.Types.ObjectId], ref: "Games", unique: true },
  owned: {type: [Schema.Types.ObjectId], ref: "Games", unique: true },
  finished: {type: [Schema.Types.ObjectId], ref: "Games", unique: true }
});
